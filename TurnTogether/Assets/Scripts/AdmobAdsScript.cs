...
public class AdmobAdsScript : MonoBehaviour
{
...
#if UNITY_ANDROID
    string bannerId = "ca-app-pub-8611849219949867/2992286347";
    string interId = "ca-app-pub-8611849219949867/3550689545";
    string rewardedId = "ca-app-pub-8611849219949867/6017070782";
    ...
    public void LoadRewardedAd(int rewardPrice) {
        ...
        RewardedAd.Load(rewardedId, adRequest, (RewardedAd ad, LoadAdError error) =>
        {
            ...
            ShowRewardedAd(rewardPrice);
        });
    }
    public void ShowRewardedAd(int rewardPrice) {
